System.register(['reflect-metadata', 'object-path', 'dotenv', 'fs', 'tsyringe', 'json5', 'yaml'], function (exports) {
  'use strict';
  var objectPath, dotenv, fs, injectable, container, parse, yaml;
  return {
    setters: [function () {}, function (module) {
      objectPath = module.default;
    }, function (module) {
      dotenv = module.default;
    }, function (module) {
      fs = module.default;
    }, function (module) {
    ...
    execute: function () {
       ...
       *
       */
      var AbstractConfig = exports('AbstractConfig', /** @class */ (function () {
